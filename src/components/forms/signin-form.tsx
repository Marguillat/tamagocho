  ...
  return (
    <div className='space-y-6'>
      ...
      <form className='flex flex-col justify-center space-y-4' onSubmit={handleSubmit}>
        ...
        <button
          className='w-full group bg-white flex items-center border-2 border-black px-4 py-2 text-md w-fit gap-2 rounded-md text-black hover:cursor-pointer hover:bg-black hover:text-white transition-all duration-300'
          onClick={(e) => {
            e.preventDefault()
            setIsLoading(true)
        ...
        <button
          className='w-full group bg-white flex items-center border-2 border-green-600 px-4 py-2 text-md w-fit gap-2 rounded-md text-black hover:cursor-pointer hover:bg-black hover:text-white transition-all duration-300'
          onClick={(e) => {
            e.preventDefault()
            setIsLoading(true)
        ...
        >
          {/*Logo google*/}
          <svg height={32} version="1.1" viewBox="0 0 268.1522 273.8827" overflow="hidden" xmlSpace="preserve" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" >
            <defs>
              <linearGradient id="a">
