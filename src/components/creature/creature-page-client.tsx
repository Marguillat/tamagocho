...
export function CreaturePageClient({
  monster,
}: CreaturePageClientProps): React.ReactNode {
  ...
  const [equippedBackground, setEquippedBackground] =
    useState<DBBackground | null>(null);
  ...
  const traits: MonsterTraits = useMemo(
    () =>
      parseMonsterTraits(currentMonster.traits) ?? {
        bodyColor: "#FFB5E8",
        accentColor: "#FF9CEE",
        eyeColor: "#2C2C2C",
        antennaColor: "#FFE66D",
        ...
        if (response.ok) {
          ...
          if (
            ...
            const xpDiff =
              updatedMonster.level > currentMonster.level
                ? updatedMonster.xp +
                  (updatedMonster.level - currentMonster.level - 1) *
                    currentMonster.maxXp +
                  (currentMonster.maxXp - currentMonster.xp)
                : updatedMonster.xp - currentMonster.xp;
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="pointer-events-none absolute top-40 left-20 text-5xl animate-twinkle-delayed">
        ✨
      </div>
      <div className="pointer-events-none absolute bottom-40 right-60 text-4xl animate-twinkle">
        💫
      </div>
        ...
        <div className="flex justify-between items-center mb-6 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="group relative overflow-hidden inline-flex items-center gap-2 bg-gradient-to-r from-green-400 to-emerald-500 hover:from-green-500 hover:to-emerald-600 text-white font-black px-4 py-2 rounded-xl shadow-lg ring-2 ring-green-200/50 transition-all duration-300 hover:scale-105 active:scale-95 hover:cursor-pointer"
            >
