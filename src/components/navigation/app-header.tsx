...
export default function AppHeader({
  ...
  const navItems = [
    ...
    {
      href: "/app/public-monsters",
      label: "Monstres Publics",
      icon: "🌍",
  ...
  return (
    <header className="hidden md:block bg-gradient-to-r from-purple-100 via-pink-100 to-orange-100 sticky top-0 z-50">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="text-xl">🪙 Koins</span>
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              ...
              {isLoggingOut ? (
                <>
                  <span className="text-2xl relative z-10 animate-spin">
                    ⏳
                  </span>
