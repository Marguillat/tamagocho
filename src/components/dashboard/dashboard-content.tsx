...
function DashboardContent({
  ...
  const favoriteMoodMessage = useFavoriteMoodMessage(
    stats.favoriteMood,
    stats.totalMonsters,
  );
  ...
  const handleMonsterSubmit = useCallback(
    (values: CreateMonsterFormValues): void => {
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="rounded-lg bg-moccaccino-50 border-2 border-moccaccino-200 p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-4xl font-bold text-moccaccino-700">
                      {stats.totalMonsters}
                    </div>
              ...
              <div className="rounded-lg bg-fuchsia-blue-50 border-2 border-fuchsia-blue-200 p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-4xl font-bold text-fuchsia-blue-700">
                      {stats.highestLevel}
                    </div>
